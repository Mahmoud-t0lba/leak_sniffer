...
class AvoidUncancelledTimerRule extends DartLintRule {
  ...
  static const _code = LintCode(
    ...
    problemMessage: 'Timer fields created by a class should be cancelled from a lifecycle cleanup method.',
    correctionMessage: 'Call cancel() from a lifecycle method such as dispose(), close(), cancel(), or onClose().',
    errorSeverity: ErrorSeverity.WARNING,
  );

  static const _resourceAnalyzer = timerResourceAnalyzer;
